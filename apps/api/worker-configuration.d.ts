/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a9ffbf575bc9bf21f2bf324a760d92f7)
// Runtime types generated with workerd@1.20260831.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	OSM_VERIFY_RL: RateLimit;
	OSM_API_BASE: "https://api.openstreetmap.org";
	OSM_VERIFY_TTL_S: "3600";
	ENV: "production";
	ADMIN_KEYS_JSON: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OSM_API_BASE" | "OSM_VERIFY_TTL_S" | "ENV" | "ADMIN_KEYS_JSON">> {}
}
